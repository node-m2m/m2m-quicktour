# Quick Tour
   1. [Cloud Publish-Subscribe Pattern](#m2m-publish-subscribe-pattern)
   2. [Cloud Client-Server Pattern](#m2m-client-server-pattern)
   ...
   7. [Cloud Client-Server Using HTTP Api](https://github.com/EdAlegrid/http-api)
